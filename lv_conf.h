...
#if defined(ANNEAL_PLATFORM_AD5M) || defined(ANNEAL_PLATFORM_CC1) || \
    defined(ANNEAL_PLATFORM_MIPS) || defined(ANNEAL_PLATFORM_K1) || \
    defined(ANNEAL_PLATFORM_AD5X) || defined(ANNEAL_PLATFORM_K2) || \
    defined(ANNEAL_PLATFORM_SNAPMAKER_U1)
...
#if !defined(ANNEAL_PLATFORM_CC1)
 ...
 * Camera uses stb_image for JPEG decoding (header-only, zero deps). */
    ...
    !defined(ANNEAL_PLATFORM_AD5X) && !defined(ANNEAL_PLATFORM_K2) && \
    !defined(ANNEAL_PLATFORM_SNAPMAKER_U1)
#define ANNEAL_HAS_CAMERA 1
#else
#define ANNEAL_HAS_CAMERA 0
#endif
 ...
 * - ANNEAL_DISPLAY_SDL:   Desktop development (macOS/Linux with SDL2)
 * - ANNEAL_DISPLAY_FBDEV: Linux framebuffer (AD5M, older Pi)
 * - ANNEAL_DISPLAY_DRM:   Linux DRM/KMS (Raspberry Pi 4/5)
 *
...
#if defined(ANNEAL_DISPLAY_FBDEV) || defined(ANNEAL_DISPLAY_DRM)
...
#if defined(ANNEAL_DISPLAY_DRM) && !defined(ANNEAL_PLATFORM_SNAPMAKER_U1)
